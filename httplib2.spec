...
%prep
%setup -q -n httplib2-0.20.1
cd %{_builddir}/httplib2-0.20.1
...
cp %{_builddir}/httplib2-0.20.1/LICENSE %{buildroot}/usr/share/package-licenses/httplib2/ad69fe8cc106ba1fc060d239d0483740bf66f1f9
