...
%prep
%setup -q -n httplib2-0.19.1
cd %{_builddir}/httplib2-0.19.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617213232
...
cp %{_builddir}/httplib2-0.19.1/LICENSE %{buildroot}/usr/share/package-licenses/httplib2/ad69fe8cc106ba1fc060d239d0483740bf66f1f9
